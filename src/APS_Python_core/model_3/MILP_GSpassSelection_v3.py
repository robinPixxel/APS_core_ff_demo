                ...
                for csg in self.data['csgList_s'][s]:
                    for k in self.data['TW_index_list_SatIdGSID'][csg]:
                        ...
                        for p in ptw_list_[1:]:
                            ...
                            prev_index_list = [ [only_img_case[3],only_img_case[4],only_img_case[1]] for only_img_case in self.data['prev_thermal_list'] if ((only_img_case[2]==p) and (only_img_case[0]==s)) ] 
